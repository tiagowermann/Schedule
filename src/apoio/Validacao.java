...
public class Validacao {
    ...
    // Comapara a data atual com a data informada pelo cliente
    public int comparaDatas(String tabela){
        
        // Pega a data atual do sistema
        Date dataAtual = new Date(System.currentTimeMillis());
        SimpleDateFormat formatarData = new SimpleDateFormat("dd/MM/yyyy");
        String data2 = String.valueOf(formatarData.format(dataAtual));
        
        
        String data1 = tabela;
        System.out.println("Data Digitada: "+data1);
        System.out.println("Data Atual: "+data2);
        System.out.println("Comparação entre datas: "+ data1.compareTo(data2) );
